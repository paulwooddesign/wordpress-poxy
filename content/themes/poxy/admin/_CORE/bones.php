...
function simplify_post_class($classes) {
    ...
    foreach($classes as $id => $class)
        ...
        ||  (strpos($class, "status-") !== false)
      	...
      	||  (strpos($class, "page-") !== false)
      	||  (strpos($class, "hentry") !== false)
      	||  (strpos($class, "instock") !== false)
...
//////////////////////////////////////////////////
add_filter('body_class','poxy_browser_body_class');
function poxy_browser_body_class($classes) {
...
function my_body_class($wp_classes, $extra_classes)
{
    ...
    $whitelist = array('gecko', 'admin-bar', 'ie', 'unknown', 'iphone', 'lynx', 'opera', 'safari', 'ns4', 'chrome', 'error404');
