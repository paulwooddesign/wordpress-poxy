(function() {
  ...
  angular.module('poxy', ['slick', 'ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ngMap', 'zumba.angular-waypoints']).config(function($routeProvider) {
    ...
    return function(scope, element) {
      var applyScopeVars, fluidDiv;
      applyScopeVars = function() {
        ...
        scope.mainNavHeight = parseInt(getComputedStyle(mainNav, "height"), 10);
        scope.mainNavWidth = parseInt(getComputedStyle(mainNav, "width"), 10);
        return scope.logoWidth = parseInt(getComputedStyle(logo, "width"), 10);
      };
      fluidDiv = element[0].querySelector("#logo");
    ...
    link = function(scope, element, attrs) {
      var path, renderSVG;
      path = function(icon) {
        return "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\">" + "<path d=\"" + icons[icon] + "\"/>" + "</svg>";
      };
      renderSVG = function() {
