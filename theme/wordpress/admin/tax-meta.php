...
if (is_admin()){
  ...
  //checkbox field
  $my_meta->addCheckbox($prefix.'usda_organic',array('name'=> __('USDA Organic ','tax-meta')));
  $my_meta->addCheckbox($prefix.'glutten_free',array('name'=> __('Gluten Free ','tax-meta')));
  $my_meta->addCheckbox($prefix.'non_gmo',array('name'=> __('NON GMO ','tax-meta')));
  $my_meta->addCheckbox($prefix.'kosher',array('name'=> __('Kosher ','tax-meta')));
  $my_meta->addCheckbox($prefix.'scroll_kosher',array('name'=> __('Scroll Kosher ','tax-meta')));
